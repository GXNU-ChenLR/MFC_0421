...
// MFC_0421_1Dlg.cpp : 实现文件
//

#include "stdafx.h"
#include "MFC_0421_1.h"
#include "MFC_0421_1Dlg.h"
...
CMFC_0421_1Dlg::CMFC_0421_1Dlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(IDD_MFC_0421_1_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CMFC_0421_1Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CMFC_0421_1Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
// CMFC_0421_1Dlg 消息处理程序

BOOL CMFC_0421_1Dlg::OnInitDialog()
{
...
void CMFC_0421_1Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CMFC_0421_1Dlg::OnQueryDragIcon()
{
